...
impl TmpList{
    ...
    pub fn into_const_list(self) -> CoreResult<ConstList>{
    ...
    pub fn into_inner_list(self) -> CoreResult<ConstInnerList>{
        // if self.compatible.is_some(){
    ...
    pub fn into_const_data(self) -> CoreResult<ConstTable>{
        // if self.compatible.is_some(){
    ...
    pub fn into_mut_list(self) -> CoreResult<MutList>{
    ...
    pub fn into_mut_inner_list(self) -> CoreResult<MutInnerList>{
        // if self.compatible.is_some(){
    ...
    pub fn into_inner_def(self) -> CoreResult<ListDefObj>{
        // if self.compatible.is_some(){
    ...
    pub fn into_inner_mut_def(self, undefinable : bool) -> CoreResult<MilDefObj>{
        if self.old.is_some(){
            Err(format!("{} Old is not needed for InnerDef {}", self.span.line_str(), self.span.slice()))?
        }
        if self.default.is_none(){
