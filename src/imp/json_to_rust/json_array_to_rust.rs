...
pub fn json_array_to_rust(array : &Vec<JVal>, value_type : VarType, span : &Span, names : &Names) -> CoreResult<RustValue>{
    use GatResult::*;
...
pub fn get_array(a : &[JVal], array_type : &ArrayType, names : &Names) -> CoreResult<RustArray>{
