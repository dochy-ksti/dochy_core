...
pub fn adjust_mut(def : &ListDefObj, old_list : LinkedMap<MutItem>, names : &Names) -> CoreResult<LinkedMap<MutItem>>{
...
pub fn adjust_mut_list(new : MutList, old : MutList, names : &Names) -> CoreResult<MutList>{
...
pub fn adjust_mut_inner_list(def : &ListDefObj, old : MutInnerList, names : &Names) -> CoreResult<MutInnerList>{
